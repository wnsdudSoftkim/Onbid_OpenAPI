...
class RecyclerAdapter3(
    ...
    inner class ViewHolder(view: View): RecyclerView.ViewHolder(view){
        val best = view.findViewById<TextView>(R.id.best)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(inflater.inflate(R.layout.best_layout,parent,false))
    }
    ...
    override fun onBindViewHolder(holder: RecyclerAdapter3.ViewHolder, position: Int) {
