...
class grid2_fragment4 : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel.Livegrid2fragment4data.observe(viewLifecycleOwner, Observer {
            if (viewModel.grid1fragment4data != null) {
                val adapter =
                    RecyclerAdapter(
                        viewModel.grid2fragment4data,
    ...
    fun initview() {
        if (viewModel.grid2fragment4data.size==0) {
            RetrofitClient.dataservice.getclick20("0005","20","1")
                .enqueue(object : retrofit2.Callback<Camco> {
                    ...
                    override fun onResponse(
                        ...
                        //viewModel로 데이터를 보내줌.
                        if (body != null) {
                            viewModel.myGrid2Fragment4SetData(body)
