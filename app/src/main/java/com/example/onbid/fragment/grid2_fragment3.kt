...
class grid2_fragment3 : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel.Livegrid2fragment3data.observe(viewLifecycleOwner, Observer {
            if (viewModel.grid2fragment3data != null) {
                val adapter =
                    RecyclerAdapter(
                        viewModel.grid2fragment3data,
    ...
    fun initview() {
        if (viewModel.grid2fragment3data.size==0) {
            animation_view2.visibility=View.VISIBLE
            RetrofitClient.dataservice.getclick20("0004","20","1")
                .enqueue(object : retrofit2.Callback<Camco> {
                    ...
                    override fun onResponse(
                        ...
                        //viewModel로 데이터를 보내줌.
                        if (body != null) {
                            viewModel.myGrid2Fragment3SetData(body)
